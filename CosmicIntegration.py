...
if __name__ == "__main__":
    ...
    start_CI = time.time()
    detection_rate, formation_rate, merger_rate, redshifts, COMPAS, Average_SF_mass_needed, shell_volumes = find_detection_rate(args.path, dco_type=args.dco_type, weight_column=args.weight_column,
    ...
    if args.append_rates:
        ...
        append_rates(args.path, args.outfname, detection_rate, formation_rate, merger_rate, redshifts, COMPAS, Average_SF_mass_needed, shell_volumes, n_redshifts_detection,
